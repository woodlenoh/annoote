    ...
    const content = {
      en: {
        ...
        sections: [
          ...
          { title: "User Responsibilities", items: ["Users are responsible for the content they share on the website.", "Any information or materials uploaded must not infringe upon the rights of others."] },
      ...
      jp: {
        ...
        sections: [
          ...
          { title: "ユーザーの責任", items: ["ユーザーは、ウェブサイト上で共有するコンテンツに責任を負います。", "アップロードされた情報や資料は、他者の権利を侵害してはなりません。"] },
      ...
      cn: {
        ...
        sections: [
          ...
          { title: "用户责任", items: ["用户对其在网站上分享的内容负责。", "上传的任何信息或资料不得侵犯他人的权利。"] },
        ...
        <div className="flex flex-col items-center">
          ...
          <div className="w-full">
            {content.sections.map((section, index) => (
              <div key={index} className="p-8 rounded-2xl border shadow-inner mb-4">
